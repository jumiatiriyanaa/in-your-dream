...
<body>
    <div class="container mt-5 mb-5">
        ...
        {{-- <div class="order-summary mb-4">
            <h5>Order Summary</h5>
            <p><strong>Invoice #:</strong> INV/IYDSTUDIO/{{ now()->format('YmdHis') }}</p>
            <p><strong>Description:</strong> Pembayaran paket studio foto</p>
            <p><strong>Pay before:</strong> {{ \Carbon\Carbon::now()->addDays(1)->format('F j, Y \a\t H:i') }}</p>
            <p class="total-payment">Total Amount Due: Rp{{ number_format($reservation->total_payment, 0, ',', '.') }}
            </p>
        </div> --}}
