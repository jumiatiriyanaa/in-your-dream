...
@section('content')
    <div class="container mt-3 mb-5">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <span>Tambahan Paket: <b>Rp.
                            {{ number_format($reservation->additional_price, 0, ',', '.') }}</b></span><br>
        ...
        <form action="{{ route('wedding-package.upload-proof') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
