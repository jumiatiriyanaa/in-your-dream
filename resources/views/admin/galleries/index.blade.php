    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Manajemen Gallery</li>
            </ol>
        </nav>
    </div>
    <!-- End Page Title -->
                        ...
                        <div class="card recent-sales overflow-auto">
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.galleries.create') }}">+ Tambah Data
                                            Gallery</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($galleries as $gallery)
                                            <tr>
                                                ...
                                                <td>{{ $gallery->package->name }}</td>
                                                <td><img src="{{ asset('storage/' . $gallery->image_path) }}"
                                                        width="100"></td>
                                                <td>
                                                    <!-- Edit Badge -->
                                                    ...
                                                    <div class="modal fade" id="deleteModal{{ $gallery->id }}"
