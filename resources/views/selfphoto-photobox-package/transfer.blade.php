...
@section('content')
    <div class="container mt-3 mb-5">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <span>Harga Penambahan Orang: <b>Rp.
                            {{ number_format($reservation->additional_person_cost, 0, ',', '.') }}</b></span><br>
        ...
        <form action="{{ route('selfphoto-photobox-package.upload-proof') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
